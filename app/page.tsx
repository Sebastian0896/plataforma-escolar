    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center p-4">
      <div className="text-center max-w-sm">
        ...
        <div className="space-y-3">
          <Link
            href="/login"
            className="block w-full bg-blue-600 text-white py-3.5 rounded-xl text-lg font-medium hover:bg-blue-700 transition-colors shadow-md"
          >
            Ingresar
          </Link>
          ...
          <Link
            ...
            className="block w-full bg-green-600 text-white py-3.5 rounded-xl text-lg font-medium hover:bg-green-700 transition-colors shadow-md"
          >
            👩‍🏫 Registro Docente
          </Link>
        </div>
